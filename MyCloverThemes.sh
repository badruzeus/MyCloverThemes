...
git archive --remote=git://git.code.sf.net/p/cloverefiboot/themes HEAD themes/Aero256 | tar -x -v
...
git archive --remote=git://git.code.sf.net/p/cloverefiboot/themes HEAD themes/BeautyDark256 | tar -x -v
...
git archive --remote=git://git.code.sf.net/p/cloverefiboot/themes HEAD themes/Buttons256 | tar -x -v
...
git archive --remote=git://git.code.sf.net/p/cloverefiboot/themes HEAD themes/Circla256 | tar -x -v
...
git archive --remote=git://git.code.sf.net/p/cloverefiboot/themes HEAD themes/DarkBoot256 | tar -x -v
...
git archive --remote=git://git.code.sf.net/p/cloverefiboot/themes HEAD themes/Glassy256 | tar -x -v
...
git archive --remote=git://git.code.sf.net/p/cloverefiboot/themes HEAD themes/Greenify256 | tar -x -v
git archive --remote=git://git.code.sf.net/p/cloverefiboot/themes HEAD themes/Hex256 | tar -x -v
git archive --remote=git://git.code.sf.net/p/cloverefiboot/themes HEAD themes/HexaCore | tar -x -v
git archive --remote=git://git.code.sf.net/p/cloverefiboot/themes HEAD themes/HexaCore256 | tar -x -v
...
git archive --remote=git://git.code.sf.net/p/cloverefiboot/themes HEAD themes/HexagonDark256 | tar -x -v
...
git archive --remote=git://git.code.sf.net/p/cloverefiboot/themes HEAD themes/Lightness256 | tar -x -v
...
git archive --remote=git://git.code.sf.net/p/cloverefiboot/themes HEAD themes/Luxury256 | tar -x -v
...
git archive --remote=git://git.code.sf.net/p/cloverefiboot/themes HEAD themes/Nightwish256 | tar -x -v
...
git archive --remote=git://git.code.sf.net/p/cloverefiboot/themes HEAD themes/Outlines256 | tar -x -v
...
git archive --remote=git://git.code.sf.net/p/cloverefiboot/themes HEAD themes/SmoothDark256 | tar -x -v
git archive --remote=git://git.code.sf.net/p/cloverefiboot/themes HEAD themes/Sphere | tar -x -v
git archive --remote=git://git.code.sf.net/p/cloverefiboot/themes HEAD themes/Sphere256 | tar -x -v
