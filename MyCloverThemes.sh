...
git archive --remote=git://git.code.sf.net/p/cloverefiboot/themes HEAD themes/Hackintosh_ID | tar -x -v
...
git archive --remote=git://git.code.sf.net/p/cloverefiboot/themes HEAD themes/iOSX | tar -x -v
git archive --remote=git://git.code.sf.net/p/cloverefiboot/themes HEAD themes/iOSX256 | tar -x -v
